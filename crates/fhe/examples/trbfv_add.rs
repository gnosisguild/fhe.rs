...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    i = 0;
    // WARNING: This uses deprecated insecure methods that reconstruct secrets in memory!
    // TODO: Update to use secure_partial_decrypt + secure_threshold_decrypt methods
    ...
    println!("⚠️  WARNING: This example uses INSECURE methods that reconstruct secret keys!");
    println!("🔒 For secure threshold cryptography, see hierarchical_trbfv_add.rs");
    println!("📁 File: trbfv_add.rs (INSECURE - for reference only)");
