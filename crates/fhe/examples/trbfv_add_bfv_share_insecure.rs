...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    // Smudging shares travel as opaque exported payloads split into
    // plaintext-sized chunks; the recipient reassembles and validates them.
